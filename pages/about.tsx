...
const AboutPage: NextPage = () => {
    return (
        <>
            <div className="w-full flex justify-items-center items-center flex-wrap">
                <div className="w-full menuMin:w-2/3">
                    ...
                    <p className="text-xl pb-12 text-whippy menuMin:pr-4">
                        My name is Adri&aacute;n Terrassa, and I started to develop webs since 2013 self-taught. Actually I&apos;m an active collaborator to
            ...
            <div className="w-full my-12 mx-auto menuMin:w-1/2">
                <h2 className="text-4xl my-4 font-bold text-whippy">My programming skills.</h2>
                <SkillBar className="p-2" name="ReactJS" level={100} color="#3fb0e4" />
                <SkillBar className="p-2" name="SomeOtherTech" level={80} color="red" />
            </div>
        </>
    );
};
