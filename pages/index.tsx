    ...
    return (
        <>
            <div className="w-full flex justify-items-center flex-wrap">
                <h1 className="text-6xl w-full pt-10 pb-6 uppercase font-bold bg-clip-text bg-gradient-to-br from-typescript to-pink-400 text-transparent menuMin:text-9xl">
                    Hi visitor!
                </h1>
