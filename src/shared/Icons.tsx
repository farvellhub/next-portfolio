...
export const CSSIcon = <FaCss3Alt className="text-2xl menuMin:text-3xl text-css" />;
export const ReactIcon = <FaReact className="text-2xl menuMin:text-3xl text-react" />;
...
export const SassIcon = <FaSass className="text-2xl menuMin:text-3xl text-sass" />;
export const HerokuIcon = <SiHeroku className="text-2xl menuMin:text-3xl text-heroku" />;
export const JestIcon = <SiJest className="text-2xl menuMin:text-3xl text-jest" />;
